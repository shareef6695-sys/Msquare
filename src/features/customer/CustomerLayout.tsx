          ...
          <aside className="w-full lg:w-64 space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <nav className="space-y-1">
                ...
                <button className="flex items-center gap-3 px-4 py-3 w-full text-sm font-medium text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-xl transition-colors mt-4">
            ...
            <div className="bg-primary-600 p-6 rounded-2xl text-white shadow-lg shadow-primary-100">
              <h4 className="font-bold mb-2">Need Help?</h4>
              <p className="text-sm text-primary-100 mb-4">Our support team is available 24/7 to assist you.</p>
              <button className="w-full bg-white text-primary-600 py-2 rounded-lg text-sm font-bold hover:bg-primary-50 transition-colors">
                Contact Support
              </button>
            </div>
          </aside>
